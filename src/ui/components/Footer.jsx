        ...
        <>
            <footer className="footer section">
                    ...
                    <div className="footer__content">
                        <div>
                            ...
                            <ul className="footer__links">
                                ...
                                <li>
                                    <a href="#" className="footer__link">Category</a>
                                </li>
                                <li>
                                    <a href="#" className="footer__link">Contact info</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="footer__links">
                                ...
                                <li>
                                    <a href="#" className="footer__link">Popular news</a>
                                </li>
                                <li>
                                    <a href="#" className="footer__link">Recent news</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="footer__info container">
                    ...
                    <a href="#" className="footer__privacy"> Terms & Conditions </a>
                </div>
            </footer>
        </>
    )
